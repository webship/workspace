...
if [ -d "${WORKSPACE_ROOT}/${doc_name}/thunder" ]; then
  (cd "${WORKSPACE_ROOT}/${doc_name}/thunder" && ddev delete -y -O 2>/dev/null) ;
  rm -rf "${WORKSPACE_ROOT}/${doc_name}/thunder" ;
fi

mkdir -p "${WORKSPACE_ROOT}/${doc_name}/thunder" ;
cd "${WORKSPACE_ROOT}/${doc_name}/thunder" ;
