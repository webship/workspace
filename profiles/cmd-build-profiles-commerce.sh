...
if [ -d "${WEBSHIP_WORKSPACE_ROOT}/${doc_name}/commerce" ]; then
  (cd "${WEBSHIP_WORKSPACE_ROOT}/${doc_name}/commerce" && ddev delete -y -O 2>/dev/null) ;
  rm -rf "${WEBSHIP_WORKSPACE_ROOT}/${doc_name}/commerce" ;
fi

mkdir -p "${WEBSHIP_WORKSPACE_ROOT}/${doc_name}/commerce" ;
cd "${WEBSHIP_WORKSPACE_ROOT}/${doc_name}/commerce" ;
