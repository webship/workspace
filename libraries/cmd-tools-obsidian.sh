...
# graph in graphs/libraries/<project>/obsidian/.
#
...
eval $(parse_yaml ${WORKSPACE_CONFIG}/workspace.libraries.settings.yml);

ARGPARSE_DESCRIPTION="Build an Obsidian vault from the knowledge graph of a project in the libraries workspace"
