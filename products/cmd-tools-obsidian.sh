...
# graph in graphs/products/<project>/obsidian/.
#
...
eval $(parse_yaml ${WORKSPACE_CONFIG}/workspace.products.settings.yml);

ARGPARSE_DESCRIPTION="Build an Obsidian vault from the knowledge graph of a project in the products workspace"
