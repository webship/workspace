...
# graph in graphs/recipes/<project>/obsidian/.
#
...
eval $(parse_yaml ${WORKSPACE_CONFIG}/workspace.recipes.settings.yml);

ARGPARSE_DESCRIPTION="Build an Obsidian vault from the knowledge graph of a project in the recipes workspace"
