...
# workspace-name: Website Starter 1.0.x (Drupal 11.4.x)

# Build a Drupal 11.4.x recommended project on PHP 8.4 and install it with the
# Website Starter recipe (drupal/website_starter 1.0.x-dev).
# https://www.drupal.org/project/website_starter
#
#   bash cmd-website_starter-1-0-x-project.sh mysite
#   bash cmd-website_starter-1-0-x-project.sh mysite --with-pending-fixes --add-users
