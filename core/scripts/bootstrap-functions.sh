...
source ${WORKSPACE_SCRIPTS}/functions/fun-build-webships.sh || exit 1 ;
...
# Include proposing an agent, skill or prompt back to the shared repository.
source ${WORKSPACE_SCRIPTS}/functions/fun-items-propose.sh || exit 1 ;
