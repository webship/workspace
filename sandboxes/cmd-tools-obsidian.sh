...
# graph in graphs/sandboxes/<project>/obsidian/.
#
...
ARGPARSE_DESCRIPTION="Build an Obsidian vault from the knowledge graph of a project in the sandboxes workspace"
